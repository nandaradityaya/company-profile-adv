jQuery(function ($) {
  ...
  function menuSticky() {
    ...
    $(window).scrollTop() > navHeight
      ? $("nav, .menu-toggle").addClass("sticky")
      : $("nav , .menu-toggle").removeClass("sticky");
  }
  ...
  if ($("#googleMap").length) {
    ...
    function init() {
      var mapOptions = {
        ...
        center: new google.maps.LatLng(41.96677, -71.186996), // New York
        ...
        styles: [
          ...
          },
          {
            ...
            stylers: [{ color: "#f4f4f4" }, { lightness: 20 }],
          },
          {
            featureType: "poi",
            elementType: "geometry",
            stylers: [{ color: "#f4f4f4" }, { lightness: 21 }],
          },
          {
            featureType: "poi.park",
            elementType: "geometry",
            stylers: [{ color: "#48c7ec" }, { lightness: 21 }],
          },
          {
          ...
          },
          {
            featureType: "transit",
            elementType: "geometry",
            stylers: [{ color: "#48c7ec" }, { lightness: 19 }],
          },
          {
            featureType: "water",
            elementType: "geometry",
